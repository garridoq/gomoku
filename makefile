...
main: main.o Board.o move.o evaluation.o move_tree.o Pattern.o 
	g++ -std=c++14 main.o Board.o move.o evaluation.o move_tree.o Pattern.o -o main -O3

test_move: test_move.o move.o Board.o
	g++ -std=c++14 test_move.o Board.o move.o -o test_move -O3

test_tree: test_tree.o move.o Board.o move_tree.o evaluation.o Pattern.o
	g++ -std=c++14 test_tree.o Board.o move.o move_tree.o evaluation.o Pattern.o -o test_tree -O3

test_eval: test_eval.o move.o Board.o move_tree.o evaluation.o Pattern.o
	g++ -std=c++14 test_eval.o Board.o move.o move_tree.o evaluation.o Pattern.o -o test_eval -O3

test_won: test_won.o move.o Board.o evaluation.o Pattern.o
	g++ -std=c++14 test_won.o Board.o move.o evaluation.o Pattern.o -o test_won -O3
